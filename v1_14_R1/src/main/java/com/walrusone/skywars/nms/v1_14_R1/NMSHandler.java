package com.walrusone.skywars.nms.v1_14_R1;
...
public class NMSHandler
    ...
    public void updateChunks(World world, List<org.bukkit.Chunk> chunks) {
        ...
        for (Iterator<Chunk> localIterator1 = chunks.iterator(); localIterator1.hasNext(); localIterator2.hasNext()) {
            ...
            net.minecraft.server.v1_14_R1.World mcWorld = ((CraftChunk) currentChunk).getHandle().world;
            localIterator2 = (Iterator<EntityHuman>) mcWorld.getPlayers().iterator();
